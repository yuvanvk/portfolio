...
export const MusicPlayer = () => {
  ...
  return (
    ...
    <div className="font-instrument-serif text-lg mt-10 md:mt-24">Hum for some time...</div>
      <div className="w-full px-4 py-3 bg-neutral-100 dark:bg-neutral-900 rounded-xl flex justify-between items-center relative border border-neutral-200 dark:border-neutral-800 ">
        ...
        <div className="absolute -top-4 -right-1 md:-right-3 flex items-center gap-x-1 bg-neutral-100 dark:bg-neutral-800 px-1 py-1 rounded-sm border border-neutral-200 dark:border-neutral-700">
          <Spotify />
